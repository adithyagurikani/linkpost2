...
export default function NewSchedulePage() {
    ...
    return (
      <ProtectedRoute>
        <PageContainer
          ...
          breadcrumbs={[{ label: "Schedules", href: "/schedules" }, { label: "New" }]}
  ...
  return (
    <ProtectedRoute>
      <PageContainer
        title="Create Schedule"
        description="Set up a recurring posting schedule — choose times, accounts, and content template."
        breadcrumbs={[{ label: "Schedules", href: "/schedules" }, { label: "New" }]}
        actions={headerActions}
      >
        <ScheduleForm accounts={accounts as any} />
      </PageContainer>
    </ProtectedRoute>
  );
}
